...
function fnListPage(){
	...
	// 검색 조건만 포함한 URL로 이동
	var searchCondition = document.userManageVO.searchCondition.value || '';
	var searchKeyword = document.userManageVO.searchKeyword.value || '';
	var sbscrbSttus = document.userManageVO.sbscrbSttus.value || '';
	var pageIndex = document.userManageVO.pageIndex.value || '1';

	var url = "<c:url value='/uss/umt/user/EgovUserManage.do'/>";
	url += "?searchCondition=" + encodeURIComponent(searchCondition);
	url += "&searchKeyword=" + encodeURIComponent(searchKeyword);
	url += "&sbscrbSttus=" + encodeURIComponent(sbscrbSttus);
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input path="emplyrNm" id="emplyrNm" class="f_txt w_full" maxlength="50" />
