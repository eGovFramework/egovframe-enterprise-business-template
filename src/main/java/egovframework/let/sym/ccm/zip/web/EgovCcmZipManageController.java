...
public class EgovCcmZipManageController {
	...
	public String insertZip(@ModelAttribute("loginVO") LoginVO loginVO, @Valid @ModelAttribute("zip") Zip zip, BindingResult bindingResult, ModelMap model) throws Exception {
