...
public class EgovCcmZipManageController {
			...
			try {
				...
				if (!"".equals(file.getOriginalFilename())) {
					...
					if (file.getOriginalFilename().toLowerCase().endsWith(".xls")
						...
						// excelZipService.uploadExcel("ZipManageDAO.insertExcelZip",
						// file.getInputStream(), 2);
	...
	public String selectZipDetail(@ModelAttribute("loginVO") LoginVO loginVO, Zip zip, ModelMap model)
			throws Exception {
