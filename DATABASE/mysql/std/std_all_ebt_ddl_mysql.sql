...
CREATE TABLE LET_TN_EMPLYR_INFO (
  ...
  KEY LET_TN_EMPLYR_INFO_ibfk_2 (GROUP_ID),
  KEY LET_TN_EMPLYR_INFO_ibfk_1 (ORGNZT_ID),
...
CREATE TABLE LET_TN_EMPLYR_SCRTY_ESTBS (
  ...
  KEY LET_TN_EMPLYR_SCRTY_ESTBS_ibfk_4 (AUTHOR_CODE),
...
CREATE TABLE LET_TN_ENTRPRS_MBER (
  ...
  KEY LET_TN_ENTRPRS_MBER_ibfk_1 (GROUP_ID),
...
CREATE TABLE LET_TN_GNRL_MBER (
  ...
  ESNTL_ID char(20) NOT NULL COMMENT '고유ID',
  PRIMARY KEY (MBER_ID),
  KEY LET_TN_GNRL_MBER_ibfk_1 (GROUP_ID),
